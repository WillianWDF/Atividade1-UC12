...
function getImage(img_name) {
    switch (img_name) {
        case "symple1.png": return require('../images/img1.png');
        case "symple2.png": return require('../images/img2.png');
        case "symple3.png": return require('../images/img3.png');
    }
}
            ...
            return (
                <TouchableOpacity key={u.id}>
                    <View style={{ padding: 10 }}>
                        <Image style={{width: 340, height:200}} source={getImage(u.image)} />
